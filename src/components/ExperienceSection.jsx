import { getEducationalExperience, getPracticalExperience, setEducationalExperience, setPracticalExperience } from "../dataController";
    ...
    if(!addStatus){
        addSection = (
            <div className="buttonSection">
                    <button onClick={()=>changeAddStatus(true)}>
                        Add +
                    </button>
            </div>
        )
            ...
            <>
                <div className="details">
                    ...
                    <div className="buttonSection">
                            ...
                            <button onClick={()=>{changeAddStatus(false)}}>
                                Cancel
                            </button>
                    </div>
            </>
    ...
    if(type === "educational"){
        return(
            <div className="experienceSection card">
                ...
                <EducationDetails educationXP={getEducationalExperience()}/>
                {addSection}
            </div>
        );
    }else{
        return(
            <div className="experienceSection card">
                ...
                <WorkDetails workXP={getPracticalExperience()}/>
                {addSection}
            </div>
        );
    } 
