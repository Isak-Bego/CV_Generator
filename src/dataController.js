...
export function getPersonalInformation() {
    return JSON.parse(localStorage.getItem("cvGeneratorData")).personalInformation;
  }
...
export function getEducationalExperience(){
    return JSON.parse(localStorage.getItem("cvGeneratorData")).educationalExperience;
  }
...
export function getPracticalExperience(){
    return JSON.parse(localStorage.getItem("cvGeneratorData")).practicalExperience;
  }
